...
SCRIPT_URL="https://raw.githubusercontent.com/your-username/cute-claude-hooks/main/tool-tips-post.sh"

echo "🌸 Cute Claude Hooks 安装程序"
echo "================================"
...
echo "📖 自定义指南: https://github.com/your-username/cute-claude-hooks#自定义"
